...
def export_summary_json(
    ...
    summary = {
        ...
        "use_virial_velocity_scaling": bool(config.get("USE_VIRIAL_VELOCITY_SCALING", False)),
        "target_virial_ratio": float(config.get("TARGET_VIRIAL_RATIO", 1.0)),
        "use_adaptive_softening": bool(config.get("USE_ADAPTIVE_SOFTENING", False)),
        "adaptive_softening_mode": str(config.get("ADAPTIVE_SOFTENING_MODE", "density_boost")),
        "adaptive_softening_k": float(config.get("ADAPTIVE_SOFTENING_K", 1.0)),
        "adaptive_softening_min": float(config.get("ADAPTIVE_SOFTENING_MIN", 0.5)),
        "adaptive_softening_max": float(config.get("ADAPTIVE_SOFTENING_MAX", 30.0)),
        "adaptive_softening_update_every": int(config.get("ADAPTIVE_SOFTENING_UPDATE_EVERY", 10)),
        "initial_condition_adjustments": config.get("initial_condition_adjustments", {}),
