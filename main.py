...
def run_single_experiment(overrides: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    if cfg.get("SAVE_SUMMARY", True):
        ...
        write_json(output_dir / "experiment_manifest.json", {
            ...
            "barnes_hut_implementation": cfg.get("BARNES_HUT_IMPLEMENTATION"),
            "barnes_hut_max_particles_per_leaf": cfg.get("BARNES_HUT_MAX_PARTICLES_PER_LEAF"),
            "barnes_hut_direct_fallback_n": cfg.get("BARNES_HUT_DIRECT_FALLBACK_N"),
            "particles": len(ids),
            "steps": cfg.get("STEPS"),
